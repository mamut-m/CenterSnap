...
from simnet.lib import camera, datapoint
...
class EvalMethod:
    ...
    def process_sample(
        self, pose_outputs, box_outputs, seg_outputs, detections_gt, scene_name
    ):
        return True
    ...
    def draw_detections(self, seg_outputs, left_image_np, llog, prefix):
...
if __name__ == "__main__":
    ...
    model_checkpoint = ModelCheckpoint(
        filepath=hparams.output, save_top_k=-1, mode="max"
    )
